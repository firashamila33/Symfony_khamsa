...
class appDevDebugProjectContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/restaurent')) {
            // front_end_resto_home
            if ($pathinfo === '/restaurent') {
                return array (  '_controller' => 'FrontEndBundle\\Controller\\RestaurentController::indexAction',  '_route' => 'front_end_resto_home',);
            }

            if (0 === strpos($pathinfo, '/restaurent/s')) {
                // resto_single_product
                if ($pathinfo === '/restaurent/single_product') {
                    return array (  '_controller' => 'FrontEndBundle\\Controller\\RestaurentSingleProductController::indexAction',  '_route' => 'resto_single_product',);
                }

                // resto_shop_cart
                if ($pathinfo === '/restaurent/shop_cart') {
                    return array (  '_controller' => 'FrontEndBundle\\Controller\\RestaurentShopCartController::indexAction',  '_route' => 'resto_shop_cart',);
                }

            }

            if (0 === strpos($pathinfo, '/restaurent/menu')) {
                // resto_menu_categories
                if ($pathinfo === '/restaurent/menu') {
                    return array (  '_controller' => 'FrontEndBundle\\Controller\\RestaurentMenuController::cotegoriesAction',  '_route' => 'resto_menu_categories',);
                }

                // resto_menu_sub_categories
                if ($pathinfo === '/restaurent/menu/sub_menu') {
                    return array (  '_controller' => 'FrontEndBundle\\Controller\\RestaurentMenuController::sub_categoriesAction',  '_route' => 'resto_menu_sub_categories',);
                }
