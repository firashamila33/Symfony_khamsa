 ...
 */
class User extends \EspritForAll\BackEndBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', '' . "\0" . 'EspritForAll\\BackEndBundle\\Entity\\User' . "\0" . 'nom', '' . "\0" . 'EspritForAll\\BackEndBundle\\Entity\\User' . "\0" . 'prenom', '' . "\0" . 'EspritForAll\\BackEndBundle\\Entity\\User' . "\0" . 'dateNaissance', '' . "\0" . 'EspritForAll\\BackEndBundle\\Entity\\User' . "\0" . 'cin', '' . "\0" . 'EspritForAll\\BackEndBundle\\Entity\\User' . "\0" . 'adress', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'roles'];
        }
